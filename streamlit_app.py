...
# Instructions
st.subheader("Enter _a NOUN that is on your mind_ followed by an auxilliary verb such as _is, was, has,_ etc. and see what happens! :sunglasses:", divider=True)
